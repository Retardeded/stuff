...
public class Main {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        BlockChain blockChain = chainFactory.generateChainSizeOf(15, zeroesInHash);
    }
}
...
class Block implements Serializable {
    ...
    boolean hasValid(int zeroesInHash) {
        String validHashRegex = "0{" + zeroesInHash + "}[^0]\\w*";
...
class BlockChain implements Serializable {
    ...
    void adjustZeroesInHash() {
        ...
        } else if (elapsedTime < 1 && zeroesInHash < 2) {
            zeroesInHash += 1;
